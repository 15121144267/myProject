...
public class SearchProductAdapter extends BaseQuickAdapter<SearchResultResponse.ListBean, BaseViewHolder> {
    private final Context mContext;
    private final ImageLoaderHelper mImageLoaderHelper;

    public SearchProductAdapter(List<SearchResultResponse.ListBean> mList, Context context, ImageLoaderHelper imageLoaderHelper) {
