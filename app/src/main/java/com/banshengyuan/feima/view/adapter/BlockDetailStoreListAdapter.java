...
public class BlockDetailStoreListAdapter extends BaseQuickAdapter<BlockStoreListResponse.ListBean, BaseViewHolder> {
    private final Context mContext;
    private final ImageLoaderHelper mImageLoaderHelper;

    public BlockDetailStoreListAdapter(List<BlockStoreListResponse.ListBean> mList, Context context,ImageLoaderHelper imageLoaderHelper) {
