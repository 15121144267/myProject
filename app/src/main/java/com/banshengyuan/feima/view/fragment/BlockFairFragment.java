...
public class BlockFairFragment extends BaseFragment implements BlockControl.BlockView {


    @BindView(R.id.fragment_block_common)
    RecyclerView mFragmentBlockCommon;

    public static BlockFairFragment newInstance() {
        return new BlockFairFragment();
    }
    ...
    private BlockDetailFairListAdapter mAdapter;
