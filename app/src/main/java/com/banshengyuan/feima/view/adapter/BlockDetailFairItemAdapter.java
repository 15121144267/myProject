...
public class BlockDetailFairItemAdapter extends BaseQuickAdapter<BlockFairListResponse.ListBean, BaseViewHolder> {
    private final Context mContext;
    private final ImageLoaderHelper mImageLoaderHelper;

    public BlockDetailFairItemAdapter(List<BlockFairListResponse.ListBean> mList, Context context, ImageLoaderHelper imageLoaderHelper) {
