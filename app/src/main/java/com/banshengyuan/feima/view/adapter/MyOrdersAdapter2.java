...
public class MyOrdersAdapter2 extends BaseMultiItemQuickAdapter<MyOrdersResponse.ListBean, BaseViewHolder> {
    private final Context mContext;
    private ImageLoaderHelper mImageLoaderHelper;

    public MyOrdersAdapter2(List<MyOrdersResponse.ListBean> data, Context context, ImageLoaderHelper imageLoaderHelper) {
        super(data);
        mContext = context;
