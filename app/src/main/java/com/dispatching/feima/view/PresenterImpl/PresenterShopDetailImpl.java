...
public class PresenterShopDetailImpl implements ShopDetailControl.PresenterShopDetail {
    ...
    @Override
    public void requestShopGoodsList(Integer pagerNumber, Integer pagerSize) {
        mView.showLoading(mContext.getString(R.string.loading));
        Disposable disposable = mModel.shopGoodsListRequest(pagerNumber, pagerSize).compose(mView.applySchedulers())
