...
public class SpecificationSizeAdapter extends BaseQuickAdapter<String, BaseViewHolder> {
    ...
    public SpecificationSizeAdapter(List<String> notices, Context context) {
        super(R.layout.adapter_specifiaction_size, notices);
        mContext = context;
    }
