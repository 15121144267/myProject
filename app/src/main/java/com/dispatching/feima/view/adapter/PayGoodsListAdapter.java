...
public class PayGoodsListAdapter extends BaseQuickAdapter<MyOrdersResponse, BaseViewHolder> {
    private final Context mContext;
    private final ImageLoaderHelper mImageLoaderHelper;

    public PayGoodsListAdapter(List<MyOrdersResponse> notices, Context context, ImageLoaderHelper imageLoaderHelper) {
